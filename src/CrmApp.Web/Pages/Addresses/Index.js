$(function () {
    ...
    var dataTable = $('#AddressesTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(crmApp.addresses.address.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('CrmApp.Addresses.Edit'), //CHECK for the PERMISSION
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('CrmApp.Addresses.Delete'), //CHECK for the PERMISSION
                                    confirmMessage: function (data) {
                                        return l('AddressDeletionConfirmationMessage');
                                    },
                                    action: function (data) {
                                        crmApp.addresses.address
