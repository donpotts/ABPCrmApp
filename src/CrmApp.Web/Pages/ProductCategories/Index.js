$(function () {
    ...
    var dataTable = $('#ProductCategoriesTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(crmApp.productCategories.productCategory.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('CrmApp.ProductCategories.Edit'), //CHECK for the PERMISSION
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('CrmApp.ProductCategories.Delete'), //CHECK for the PERMISSION
                                    confirmMessage: function (data) {
                                        return l('ProductCategoryDeletionConfirmationMessage');
                                    },
                                    action: function (data) {
                                        crmApp.productCategories.productCategory
