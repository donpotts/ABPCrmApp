$(function () {
    ...
    var dataTable = $('#OpportunitiesTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(crmApp.opportunities.opportunity.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('CrmApp.Opportunities.Edit'), //CHECK for the PERMISSION
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('CrmApp.Opportunities.Delete'), //CHECK for the PERMISSION
                                    confirmMessage: function (data) {
                                        return l('OpportunityDeletionConfirmationMessage');
                                    },
                                    action: function (data) {
                                        crmApp.opportunities.opportunity
