$(function () {
    ...
    var dataTable = $('#ServiceCategoriesTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(crmApp.serviceCategories.serviceCategory.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('CrmApp.ServiceCategories.Edit'), //CHECK for the PERMISSION
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('CrmApp.ServiceCategories.Delete'), //CHECK for the PERMISSION
                                    confirmMessage: function (data) {
                                        return l('ServiceCategoryDeletionConfirmationMessage');
                                    },
                                    action: function (data) {
                                        crmApp.serviceCategories.serviceCategory
