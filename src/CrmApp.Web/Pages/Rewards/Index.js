$(function () {
    ...
    var dataTable = $('#RewardsTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(crmApp.rewards.reward.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('CrmApp.Rewards.Edit'), //CHECK for the PERMISSION
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('CrmApp.Rewards.Delete'), //CHECK for the PERMISSION
                                    confirmMessage: function (data) {
                                        return l('RewardDeletionConfirmationMessage');
                                    },
                                    action: function (data) {
                                        crmApp.rewards.reward
