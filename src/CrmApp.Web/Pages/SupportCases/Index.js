$(function () {
    ...
    var dataTable = $('#SupportCasesTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(crmApp.supportCases.supportCase.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('CrmApp.SupportCases.Edit'), //CHECK for the PERMISSION
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('CrmApp.SupportCases.Delete'), //CHECK for the PERMISSION
                                    confirmMessage: function (data) {
                                        return l('SupportCaseDeletionConfirmationMessage');
                                    },
                                    action: function (data) {
                                        crmApp.supportCases.supportCase
