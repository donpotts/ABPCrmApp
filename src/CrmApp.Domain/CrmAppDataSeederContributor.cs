...
public class CrmAppDataSeederContributor
    : IDataSeedContributor, ITransientDependency
{
    ...
    public CrmAppDataSeederContributor(
    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        ...
        if (await _vendorRepository.GetCountAsync() <= 0)
        {
            vendors[501] = await _vendorRepository.InsertAsync(
                new Vendor
                {
                    ...
                    AddressId = addresses[901].Id,
                    ProductId = products[101].Id,
                    ServiceId = services[201].Id,
            ...
            vendors[502] = await _vendorRepository.InsertAsync(
                new Vendor
                {
                    ...
                    AddressId = addresses[902].Id,
                    ProductId = products[102].Id,
                    ServiceId = services[202].Id,
            ...
            vendors[503] = await _vendorRepository.InsertAsync(
                new Vendor
                {
                    ...
                    AddressId = addresses[903].Id,
                    ProductId = products[103].Id,
                    ServiceId = services[203].Id,
        ...
        if (await _leadRepository.GetCountAsync() <= 0)
        {
            leads[401] = await _leadRepository.InsertAsync(
                new Lead
                {
                    ContactId = contacts[801].Id,
                    Source = "Online Webinar",
                    Status = "Interested",
                    PotentialValue = 15000,
                    OpportunityId = opportunities[601].Id,
                    AddressId = addresses[901].Id,
            ...
            leads[402] = await _leadRepository.InsertAsync(
                new Lead
                {
                    ContactId = contacts[802].Id,
                    Source = "Tech Expo",
                    Status = "Evaluating",
                    PotentialValue = 25000,
                    OpportunityId = opportunities[602].Id,
                    AddressId = addresses[902].Id,
            ...
            leads[403] = await _leadRepository.InsertAsync(
                new Lead
                {
                    ContactId = contacts[803].Id,
                    Source = "Social Media",
                    Status = "Contacted",
                    PotentialValue = 5000,
                    OpportunityId = opportunities[603].Id,
                    AddressId = addresses[903].Id,
