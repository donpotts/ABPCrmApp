...
public static class CrmAppPermissions
{
    public const string GroupName = "CrmApp";
    ...
    {
        public const string Default = GroupName + ".ServiceCategories";
        public const string Create = Default + ".Create";
        public const string Edit = Default + ".Edit";
        public const string Delete = Default + ".Delete";
    }
    ...
    public static class SupportCases
    {
        public const string Default = GroupName + ".SupportCases";
        public const string Create = Default + ".Create";
        public const string Edit = Default + ".Edit";
        public const string Delete = Default + ".Delete";
    }
    ...
    {
        public const string Default = GroupName + ".TodoTasks";
        public const string Create = Default + ".Create";
        public const string Edit = Default + ".Edit";
        public const string Delete = Default + ".Delete";
    }
